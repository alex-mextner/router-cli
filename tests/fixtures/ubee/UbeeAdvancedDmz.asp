...
<title>Residential Gateway Advanced DMZ</title>
...
function ApplyAdvDMZButton()
{
    window.document.UbeeAdvancedDmz.ApplyAdvDMZAction.value = 1;
}
...
<tr><td></td><td><label id="ID_LABEL_DMZ_ADDRESS">DMZ Address</label></td><td>
<b>
<b>192.168.0.</b><input name=AdvDmzHostIP3 size=3 maxlength=3 value=0>
</b></td></tr>
</td></tr>
</table>
</td>
...
<tr>
<td colspan=3 align=center><input type="Submit" value="Apply" align="MIDDLE" onClick="ApplyAdvDMZButton()" id="ID_BUTTON_APPLY_ADV_DMZ" >
<input type="hidden" name="ApplyAdvDMZAction" value="0"></td>
</td>
</tr>
