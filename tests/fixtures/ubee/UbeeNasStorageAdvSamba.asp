...
{
	var the_box = window.document.UbeeNasStorageAdvSamba.NasSambaDisable;
	if (the_box.checked == true) {
			window.document.UbeeNasStorageAdvSamba.NasSambaEnable.checked = false;
	}
}

function RadioButtonSambaEnable()
{
	var the_box = window.document.UbeeNasStorageAdvSamba.NasSambaEnable;
	if (the_box.checked == true) {
			window.document.UbeeNasStorageAdvSamba.NasSambaDisable.checked = false;
	}
}

function RadioButtonDisableShareAllFolders()
{
	var the_box = window.document.UbeeNasStorageAdvSamba.NasSambaDisableShareAllFolders;
	if (the_box.checked == true) {
			window.document.UbeeNasStorageAdvSamba.NasSambaEnableShareAllFolders.checked = false;
		if (usb_status == true) {
			window.document.UbeeNasStorageAdvSamba.CreateNetWorkFolderButton.disabled = false;
		} else {
			window.document.UbeeNasStorageAdvSamba.CreateNetWorkFolderButton.disabled = true;
		}
	}
}
...
{
	var the_box = window.document.UbeeNasStorageAdvSamba.NasSambaEnableShareAllFolders;
	if (the_box.checked == true) {
			window.document.UbeeNasStorageAdvSamba.NasSambaDisableShareAllFolders.checked = false;
		window.document.UbeeNasStorageAdvSamba.CreateNetWorkFolderButton.disabled = true;
	}
}
...
function ApplyButton()
{
    window.document.UbeeNasStorageAdvSamba.NasBasicApplyAction.value = 1;
}
...
<table width="100%" border="0">
   <tr>
  	<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
  	  ...
  	  <tr>
  	    <td colspan="3">(<label id="ID_LABEL_SHARE_PATH_DESC">Share folder can be accessed via </label>\\EVW32C-0N-TEST
  	      )</td>
  	    </tr>
		<tr>
			<td>&nbsp;</td>
