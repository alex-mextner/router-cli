...
<title>Residential Gateway Advanced MAC Filtering</title>
...
{
   window.document.UbeeAdvancedMacFiltering.MacFilterAction.value = 1;
}
function RemoveMacFilter()
{
   window.document.UbeeAdvancedMacFiltering.MacFilterAction.value = 2; 
}
function ClearAllMac()
{
   window.document.UbeeAdvancedMacFiltering.MacFilterAction.value = 3;
}
    ...
    <tbody><tr><td><table>
        <tbody><tr><td>
            <table>
                ...
                <tbody>
                    <tr>
                        <td align="left"><label id="ID_LABEL_MAC_FILTER_EXAMPLE">MAC Addresses (example: 02:00:00:00:01:19)</label></td>
                        <tr>
                            <td align="left">
                                <input type="text" name="NewMacFilter" size="17" maxlength="31" value=> 
					            <input type="submit" value="Add MAC Address" onClick="AddMacFilter();" align="left" id="ID_BUTTON_ADD_MAC_ADDRESS" >
	                        </td>
                        </tr>
                    </tr>
                    ...
                    <tr>
                        <td align="left"><select name="MacFilterList" size="10"><option value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</select>
                        <label id="ID_LABEL_MAC_FILTER_COUNTER_DESC">Addresses entered: </label>0/20
                        </td>
                    </tr>
			        ...
			        <tr>
                        <td align="left">
                            <input type="submit" value="Remove MAC Address" onClick="RemoveMacFilter();" align="left" id="ID_BUTTON_REMOVE_MAC_ADDRESS" >
                            <input type="submit" value="Clear All" align="left" onClick="ClearAllMac();" id="ID_BUTTON_CLEAR_ALL" >
                            <input type="hidden" name="MacFilterAction" value=>
                        </td>
                    </tr>
                </tbody>
